...
@Client.on_message(filters.command(["pause", f"pause@{USERNAME}"]) & filters.user(ADMINS) & (filters.chat(CHAT_ID) | filters.private))
...
@Client.on_message(filters.command(["resume", f"resume@{USERNAME}"]) & filters.user(ADMINS) & (filters.chat(CHAT_ID) | filters.private))
